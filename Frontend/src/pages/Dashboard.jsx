  ...
  return (
    <div className="grid gap-4 md:grid-cols-2">
      ...
      <div className="rounded-2xl border border-slate-400 dark:border-slate-700 bg-slate-300 dark:bg-slate-800 p-4">
        ...
        <div className="mt-2 flex flex-wrap gap-2">
          {["Driving Recklessly", "Wrong side Driving", "Speeding"].map((t) => (
            <span
              key={t}
              className="inline-flex items-center gap-2 rounded-xl border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-900 px-3 py-1.5 text-xs text-slate-200"
            >
      ...
      <div className="md:col-span-2 rounded-2xl border border-slate-400 dark:border-slate-700 bg-slate-300 dark:bg-slate-800 p-4">
        ...
        <div className="mt-2 h-72 w-full rounded-xl border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-900 p-4 text-center text-sm text-slate-500">
          Map placeholder
        </div>
      </div>
    </div>
